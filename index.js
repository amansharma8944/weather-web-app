...
// this is the api key that we will get from the website       ' open weather map ' 
const apikey="4643eb338b6675e8e35a8b6b2ed9d8fc";

let datakey=""

// on reload  ,  this function will help to fetch the user location and show the weather of the user location
...
// this function is for the weather of the location that user input
